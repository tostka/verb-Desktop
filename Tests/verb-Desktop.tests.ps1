# verb-Desktop.Tests.ps1

BeforeAll {
    <#
    .SYNOPSIS
    verb-Desktop.ps1 - verb-Desktop Pester Tests
    .NOTES
    Version     : 1.0.1
    Author      : Todd Kadrie
    ...
    CreatedDate : 2020-
    FileName    : verb-Desktop.Tests.ps1
    License     : MIT License
    ...
    * 7:49 AM 3/4/2020 version debugged to work with Psv5.1/ISE/VSC
    ...
    .\Tests\verb-Desktop.Tests.ps1
    Run in default config
    .EXAMPLE
    cd c:\sc\verb-Desktop\ ;
    .\Tests\verb-Desktop.Tests.ps1 -verbose
...
Describe 'Module Information' -Tags 'Command'{
    Context 'Manifest Testing' {
        ...
        It 'Valid Manifest GUID' {
            $Script:ManifestHash.Guid | Should -Be "0b3874ca-3dd9-44a0-af97-768d25aa11fb"
        }
        <#
        It 'No Format File' {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUMGxoJxG6JaYtb8NWjLMB5oWN
# YaygggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQKj8BJ
# V6rlFuMGajQr8J5aD4926zANBgkqhkiG9w0BAQEFAASBgJRH9lRyexZ1VxMwJsyN
# PlwrHsRIosTdGJDWhcRx99yJaBBEDmE48K8J+qV5sukyFsK+kED/D01tqIeN18VQ
# fad0aAR6CBRW3M1Qr1+QSVq0Qase8gpRIe6R595J8GGU6L/3ePi7O1droMt0/80B
# smUb8I4YgCgtUki0olzR5CrA
